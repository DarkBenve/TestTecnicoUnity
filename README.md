...
Questo gioco consiste nel controllare un cubo tramite uno swipe del dito (su dispositivi mobile) oppure del mouse (su PC). Una volta scelta una direzione, il cubo continua a muoversi fino a quando non incontra un muro, momento in cui si ferma ed è possibile eseguire un nuovo swipe.

Ho scelto questo sistema di controllo perché permette di giocare allo stesso modo sia su PC che su dispositivi mobile, senza dover modificare il gameplay.
